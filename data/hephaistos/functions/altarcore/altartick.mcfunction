...
execute as @e[type=marker,nbt={data:{ha:{altar_center:1b}}},tag=!hs_crafting] at @s if entity @e[type=item,distance=..1] run execute as @s at @s run function hephaistos:altarcore/lockbeforecraft